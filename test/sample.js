...
* is the starting index of the search, and `end` is the ending index of the search.
* 
...
* represents the leftmost index of the range of elements in the array to be searched.
* 
...
* element to be included in the search.
* 
