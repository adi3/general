...
* is the value to be found, `start` is the starting index of the search range, and 
* `end` is the ending index of the search range.
* 
...
* specifies the beginning index of the range of elements to be searched.
* 
...
* element that should be considered in the search.
* 
...
* `(start + end)/2`.
* 	3/ It checks if the element `x` is equal to `arr[mid]`.
* 
