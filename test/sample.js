...
* API, passing in the `sub` parameter as a part of the URL.
* 
...
* uses the `axios` library to make a GET request to the API, and then logs the 
* response to the console and returns it.
*/
